# Booking Amendments Specification: Room Booker

## Purpose
This document specifies the booking amendment workflow, which allows
authenticated non-admin users to propose changes to confirmed bookings for
admin review and approval or rejection.

## [BAMEND-000] Compliance
