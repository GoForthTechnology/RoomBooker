# Firebase Backend CD Specification: Room Booker

## Purpose
This document specifies how Cloud Functions and Firestore security rules and
indexes are continuously deployed to the Firebase project as commits land on
`main`, and how this relates to the tag-triggered hosting/Android release
flow and to Terraform.
